...
// AXIS1 RA/AZM
    ...
    (AXIS1_DRIVER_MODEL < SIMPLEFOC_DRIVER_FIRST || AXIS1_DRIVER_MODEL > SIMPLEFOC_DRIVER_LAST)
...
// AXIS2 DEC/ALT
    ...
    (AXIS2_DRIVER_MODEL < SIMPLEFOC_DRIVER_FIRST || AXIS2_DRIVER_MODEL > SIMPLEFOC_DRIVER_LAST)
